...
const addStudent = async (req, res) => {
  ...
  try {
          ...
          <div style="max-width: 500px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); border: 1px solid #e5e7eb;">
            ...
            <div style="padding: 30px 25px;">
              ...
              <div style="text-align: center; margin-top: 30px;">
                <a href="http://localhost:5173/login" style="display: inline-block; background-color: #7B1113; color: #ffffff; text-decoration: none; padding: 12px 30px; border-radius: 8px; font-weight: bold; font-size: 14px; transition: background 0.3s ease;">
                  Login to Portal
                </a>
              </div>
            </div>
    ...
    res.status(201).json({ message: 'Student registered and credentials sent via email.' });
  } catch (error) {
